                ...
                <div class="padding">
                    <div class="full col-sm-9">
                        ...
                        <div class="panel <% if(request.getParameter("regpage_type") == null){ out.print("panel-default"); } else if(request.getParameter("regpage_type").equals("1")){ out.print("panel-success"); } else if(request.getParameter("regpage_type").equals("2")){out.print("panel-danger"); } %>" style="width:70%" >
                          <div class="panel-heading" > <h3>Post News</h3> <h4><% if(request.getParameter("regpage_type") == null){ out.print(""); } else if(request.getParameter("regpage_type").equals("1")){ out.print("Post Success"); } else if(request.getParameter("regpage_type").equals("2")){out.print("Wrong Input! Please Check"); } %></h4></div>
                            <div class="panel-body">
                              <a href="#">Poster：<%=admin.getRealname()%></a> 
                              <div class="clearfix"></div>
                              <br>
                              <form role="form" action="/ICOFSOFTWARE/NewsPostServlet" method="post">
                                <div class="form-group">
                                  <label>Title</label><br>
                                  <input type="text" name="newstitle" class="form-control" id="NewsTitle" placeholder="Enter News Title" style="width:85%">
                                </div>
                                <div class="form-group">
                                  <label>Content</label><br>
                                  <textarea  name="newscontent" class="form-contrl" rows="15" cols="80" id="NewsContent" placeholder="Enter Content" style="width:85%"> </textarea> 
                                </div>
                                <!-- <div class="form-group">
